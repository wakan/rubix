...
namespace ConsoleApp1
{
    public class C3x3ParamSolver : ParamSolver
    {
        ...
        public Dictionary<Move, int[]> Tt => new Dictionary<Move, int[]>
        {
            ...
            [new Move { Identifiant = 'R', Sens = Move.EnumSens.Normal }] = new int[] { 0, 1, 8, 3, 4, 17, 6, 7, 26, 9, 10, 5, 11, 12, 13, 14, 15, 16, 23, 18, 19, 2, 21, 22, 11, 24, 25, 20 }, //11 en double
            [new Move { Identifiant = 'R', Sens = Move.EnumSens.Prime }] = new int[] { 0, 1, 20, 3, 4, 11, 6, 7, 2, 9, 10, 23, 11, 12, 13, 14, 15, 16, 5, 18, 19, 26, 21, 22, 17, 24, 25, 8 }, //11 en double
            [new Move { Identifiant = 'R', Sens = Move.EnumSens.Seconde }] = new int[] { 0, 1, 26, 3, 4, 23, 6, 7, 20, 9, 10, 17, 11, 12, 13, 14, 15, 16, 11, 18, 19, 8, 21, 22, 6, 24, 25, 3 }, //11 en double
        };
